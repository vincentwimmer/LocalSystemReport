...
<div id='info'>New reports retrieved at logon.
<br>
<br>
Notes:
<ul>
...
$bodybreakforpath = "</li>
  <li>The last 6 digits of the file name is Time (HH:MM:SS)</li>
  <li>Reports older than 30days will automatically be deleted.</li>
</ul>
</div>
"
...
ConvertTo-HTML -Head $Style -PostContent "$bodytop $reportslocation $bodybreakforpath $FileLine $bodybottom" -Title "System Health Check Reports" | Out-File "$fpath\index.html"
